...
Illustrative shape (exact serialization is E2's to finalize — TODO: pin the grammar in E2 and add
it to `grammar.ebnf` if it grows load-bearing; today it is a generated artifact, not authored):
